...
import { consumedMaterials, extraConsumedMaterials, getSpecs, listSellableProducts, materialNeeds, readOrder, reconcileOrderBoms } from "@/lib/orders"
...
export default async function OrderDetailPage({
    ...
    const [needs, extras, consumed, vocab, products, events, invoiceDrift, remissionDrift] = await Promise.all([
        materialNeeds(id),
